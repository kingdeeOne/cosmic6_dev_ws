...
//    private boolean enableLightWeightDeploy = true;
    ...
    public void setDefault() {
        ...
        setAppName("kdcosmic-" + NetUtil.getLocalHostName() + "-" + cosmicPort);
...
//			setEnableLightWeightDeploy(false);
    ...
    public void start() {
    	...
    	StaticLog.info("Cosmic Service starting! Please check url: {}", getCosmicUrl());
    	Booter.main(null);
    }
    ...
    public void setMqConsumerRegister(boolean registerOnMq, String debbugTopic) {
    	...
    	if(StrUtil.isNotBlank(debbugTopic)) {
	...
	/**
	 * Dubbo服务配置
	 * @param registerOnDubbo 是否注册到dubbo
	 * @param lookupLocal  是否使用本地服务查找
	 */
	public void setDubboConfig(boolean registerOnDubbo, boolean lookupLocal) {
		set("dubbo.registry.register", String.valueOf(registerOnDubbo));
